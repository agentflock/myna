...
| **myna-review-doc** | Multi-persona review of a technical document (PRFAQ, design doc/RFC, HLD, LLD, one-pager, or generic). Composes the right reviewer panel, runs personas in parallel, layers CoS context, saves synthesized report to `Reviews/`. |
