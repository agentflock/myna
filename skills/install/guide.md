...
| `email.processed_folder` | `per-project` (email moves to project's Processed/) or `common` (single shared folder) |
...
| `messaging_preferences.emoji_usage` | `none`, `minimal`, or `moderate` |
