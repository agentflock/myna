...
### Summary
[2-3 sentences: total thread count split between waiting-on-you and waiting-on-others, and the most overdue or highest-priority thread if any stands out. Synthesize only facts present in the vault — do not infer urgency beyond what's recorded.]
