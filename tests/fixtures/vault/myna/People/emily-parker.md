...
- Lead PM on Bridge Integration — our main interface to the Payments team
- Prefers structured written docs over meetings — will push back if a meeting could have been an email
- Runs a tight bi-weekly cross-team sync — expects pre-reads 24 hours in advance
- Direct, well-prepared, non-defensive — easy to work with
...
- [2025-11-03] Based in NYC — works ET
- [2026-02-20] Former mechanical engineer, moved into PM four years ago

## Meeting History

> Links to meeting files with this person.

- [[Adhoc/bridge-integration-kickoff]] — Bridge Integration Kickoff (upcoming session)
