...
- External vendor contact for the Helix Research vector search spike
- Based in Austin — works CT timezone
- Prefers scheduled calls over async; vendor cadence expectations
...
- [2026-03-12] Based in Austin — works CT timezone
