...
- Joined December 2025 — first job out of college
- Asks lots of questions — good instinct, don't discourage
- Struggles with open-ended tasks — give starter questions or pair for the first hour
- Gets overwhelmed by too many reviewers on a single PR — limit to two
- Very responsive to specific, actionable feedback — less so to vague "make it better" notes
...
- [2025-12-15] First job out of college — lives with roommates in Oakland
- [2026-02-18] Into climbing — boulders at Great Western Power Company on weekends
- [2026-04-08] Parents flew in for his first work anniversary dinner in December (6 months early — "they were excited")

## Meeting History

> Links to meeting files with this person.

- [[1-1s/nate-brooks]] — 1:1 meetings
