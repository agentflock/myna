...
- Prefers async written updates over status meetings — "if it fits in a Slack message, don't schedule a meeting"
- Responds best to direct, specific feedback — avoids feedback sandwiches, finds them condescending
- Uses Slack for quick questions, email for anything that needs a paper trail
- Prefers deep-work morning hours — avoid scheduling 1:1s before 11 AM
- Will push back on unclear requirements — not a weakness, a strength
- Prefers a doc review over a synchronous walkthrough when evaluating a design
...
- [2026-03-25] **Design review confidence** — open by reflecting back what she said ("doesn't earn the room yet") without judging it. Tie to the Atlas design review as a concrete next step. Name one specific thing she already does well in group settings (her incident calm) as a foundation to build on. Don't turn it into a coaching program — one nudge.
- [2026-03-20] **Documentation discipline** — largely addressed during April 1 session, but confirm she's actually drafting alongside code on Atlas now. If not, don't escalate — ask what's blocking it.
...
- [2025-10-04] Got married last fall, took the last name Carter
- [2026-02-24] Training for the Big Sur half marathon in May — runs at 6 AM
- [2026-03-18] Adopted a senior rescue dog named Pepper — may need flexibility on some late afternoons
- [2026-04-01] Mentioned interest in attending Strange Loop this fall
- [2026-04-07] Her spouse is also in tech — mentioned they're looking at houses in the East Bay

## Meeting History

> Links to meeting files with this person.

- [[1-1s/sarah-carter]] — 1:1 meetings
- [[Recurring/atlas-standup]] — Atlas standup (daily)
- [[Recurring/platform-weekly]] — Platform weekly sync
- [[Adhoc/atlas-caching-design-review]] — Atlas caching design review
- [[Adhoc/bridge-integration-kickoff]] — Bridge integration kickoff
